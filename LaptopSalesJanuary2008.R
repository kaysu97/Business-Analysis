...
#5.To better compare retail prices across stores, create boxplots of retail price by store. Now compare the prices in the two stores from (3). Does there seem to be a difference between their price distributions?
